...
public class VideoListAdapter extends BaseQuickAdapter<Asia, BaseViewHolder> {
    private Context context;

    public VideoListAdapter(@Nullable List<Asia> data, Context context) {
        super(R.layout.item_video_list_layout, data);
        this.context=context;
    }

    @Override
    protected void convert(BaseViewHolder helper, Asia item) {
