...
import com.example.module_home.adapter.VideoListAdapter;
...
public class HomeEuropeFragment extends BaseFragment {
    @BindView(R2.id.mRecyclerView)
    RecyclerView mRecyclerView;
    @BindView(R2.id.mSmartRefreshLayout)
    SmartRefreshLayout mSmartRefreshLayout;
    private List<Europe> datalist = new ArrayList<>();
    EuropeVideoListAdapter adapter;
    Unbinder unbinder;
    @Override
    public int initLayout() {
        return R.layout.fragment_home_europe;
    }
    ...
    public void initView(View view) {
        ...
        adapter = new EuropeVideoListAdapter(datalist,getContext());
    ...
    public void initData() {
        ...
        mSmartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                BmobQuery<Europe> bmobQuery = new BmobQuery<>();
                bmobQuery.setLimit(10);
                bmobQuery.setSkip(0);
                bmobQuery.order("-createdAt");
                bmobQuery.findObjects(new FindListener<Europe>() {
                    @Override
                    public void done(List<Europe> list, BmobException e) {
                        if (e==null){
                            datalist.clear();
